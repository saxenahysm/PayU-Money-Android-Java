...
function getHashes($txnid, $amount, $productinfo, $firstname, $email,$user_credentials, $udf1, $udf2, $udf3, $udf4, $udf5,$offerKey,$cardBin)
{
      ...
      $cmnMobileSdkConfig = 'get_sdk_configuration';
      $mobileSdkConfig_str = $key . '|' . $cmnMobileSdkConfig . '|GET|' . $salt;
      $mobileSdk = strtolower(hash('sha512', $mobileSdkConfig_str));
      $arr['get_sdk_configuration_hash'] = $mobileSdk;
